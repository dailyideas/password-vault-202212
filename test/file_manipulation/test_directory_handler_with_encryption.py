...
from src.file_manipulation.directory_handler_with_encryption import (
...
#### Class
#### #### #### ####
class TestDirectoryHandlerWithEncryption:
    ...
    def test_directory_handler_with_incorrect_password(self):
        ...
        with pytest.raises(ValueError):
            directory_handler = DirectoryHandlerWithEncryption(
                directory=self.DATA_DIRECTORY, key=incorrect_key
            )
